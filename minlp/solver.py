...
#  DECISION VARIABLES
model.P_ift = Var(idx["i"], idx["f"], idx["t"], domain=PositiveIntegers, initialize=1)
model.UTFW_jfwt = Var(idx["j"], idx["f"], idx["w"], idx["t"], domain=PositiveIntegers, initialize=1)
model.UTFR_jfrt = Var(idx["j"], idx["f"], idx["r"], idx["t"], domain=PositiveIntegers, initialize=1)
model.UTWR_jwrt = Var(idx["j"], idx["w"], idx["r"], idx["t"], domain=PositiveIntegers, initialize=1)
model.BUW_kwt = Var(idx["k"], idx["w"], idx["t"], domain=PositiveIntegers, initialize=1)
model.BUF_kft = Var(idx["k"], idx["f"], idx["t"], domain=PositiveIntegers, initialize=1)
model.ALLOC_ijt = Var(idx["i"], idx["j"], idx["t"], domain=PositiveIntegers, initialize=1)
model.SP_jt = Var(idx["j"], idx["t"], domain=PositiveReals, initialize=1)

#  SYSTEM VARIABLES
model.BEGINVF_jft = Var(idx["j"], idx["f"], idx["t"], domain=PositiveIntegers, initialize=1)
model.BEGINVW_jwt = Var(idx["j"], idx["w"], idx["t"], domain=PositiveIntegers, initialize=1)
model.ENDINVF_jft = Var(idx["j"], idx["f"], idx["t"], domain=PositiveIntegers, initialize=1)
model.ENDINVW_jwt = Var(idx["j"], idx["w"], idx["t"], domain=PositiveIntegers, initialize=1)
model.SPR_jt = Var(idx["j"], idx["t"], domain=PositiveReals, initialize=1)
model.ORDER_jrt = Var(idx["j"], idx["r"], idx["t"], domain=PositiveIntegers, initialize=1)
model.CUMORDER_jt = Var(idx["j"], idx["t"], domain=PositiveIntegers, initialize=1)
model.D_jrt = Var(idx["j"], idx["r"], idx["t"], domain=PositiveReals, initialize=1)
model.PC_ift = Var(idx["i"], idx["f"], idx["t"], domain=PositiveIntegers, initialize=1)
model.BACKORDER_jrt = Var(idx["j"], idx["r"], idx["t"], domain=PositiveReals, initialize=1)

#  BINARY VARIABLES
model.BSUW_kwt = Var(idx["k"], idx["w"], idx["t"], domain=Boolean, initialize=1)
model.BSUF_kft = Var(idx["k"], idx["f"], idx["t"], domain=Boolean, initialize=1)
model.SETUPW_kwt = Var(idx["k"], idx["w"], idx["t"], domain=Boolean, initialize=1)
model.SETUPF_kft = Var(idx["k"], idx["f"], idx["t"], domain=Boolean, initialize=1)
model.INTROBW_kwt = Var(idx["k"], idx["w"], idx["t"], domain=Boolean, initialize=1)
model.INTROBF_kft = Var(idx["k"], idx["f"], idx["t"], domain=Boolean, initialize=1)
model.INTROBINCURW_kw = Var(idx["k"], idx["w"], domain=Boolean, initialize=1)
model.INTROBINCURF_kf = Var(idx["k"], idx["f"], domain=Boolean, initialize=1)
model.LOST_jrt = Var(idx["j"], idx["r"], idx["t"], domain=Boolean, initialize=1)
model.OP_jrt = Var(idx["j"], idx["r"], idx["t"], domain=Boolean, initialize=1)
model.QW_kwt = Var(idx["k"], idx["w"], idx["t"], domain=Boolean, initialize=1)
model.QF_kft = Var(idx["k"], idx["f"], idx["t"], domain=Boolean, initialize=1)
model.OFFER_jt = Var(idx["j"], idx["t"], domain=Boolean, initialize=1)
...
#opt.options["bonmin.time_limit"] = 10
