 ("ALPHA [7,1] COMPUTATION")
SPR = ((y+z)*(1+0.0)-28.0+42.0)/(1+0.0) - y - z;
B = Max[ (z-12.0+42.0)/(1+0.0) - x - z, ((x+z)*(1+0.0)-26.0+42.0)/(1+0.0) - x - z ];
A = Max[ (42.0)/(1+0.0) - x - y, (x-14.0+42.0)/(1+0.0) - x - y, (y-16.0+42.0)/(1+0.0) - x - y, ((x+y)*(1+0.0)-30.0+42.0)/(1+0.0) - x - y ];
mu = { { 15.0, 17.0, 13.0 } };
